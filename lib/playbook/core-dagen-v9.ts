...
Morgen breng je 't in praktijk. Jij hebt dit 💪🏽`,
    vandaagDoen: [
      ...
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Niet in het algemeen oefenen, wel voor één echte prospect uit jouw lijst. De Mentor loopt de vijf stappen met je door, gericht op die ene persoon: wie zou jij willen uitnodigen, hoe zou jouw edification-zin voor haar klinken, wat is een logische intro-vraag van je sponsor, en zo door. Daardoor wordt het concreet in plaats van theoretisch, en heb je direct iets om mee te oefenen. Na afloop weet jij waarom jij deze prospect zou kiezen, en hoe je 'm persoonlijk zou inrichten.",
      },
      {
        ...
        uitleg:
          "Open de uitnodig-scripts en bekijk welke variant het beste past bij jou en bij deze prospect. Niet woordelijk overnemen, want dan klinkt het als een script. Wel als vertrekpunt voor je eigen woorden, zodat je niet vanaf nul hoeft te beginnen. Kies er één, pas 'm aan tot 'ie van jou is, en bewaar 'm voor morgen. De Mentor helpt 'm in jouw stem zetten.",
      },
      {
        ...
        inlineEmbed: "sponsor-melding",
        uitleg:
          "Bevestig nu met je sponsor wanneer 'ie deze week kan voor jouw eerstvolgende 3-weg. Geef 'r een paar opties zodat ze kan kiezen, bijvoorbeeld 'kun je woensdag om 20:00 of donderdag om 19:30?'. Concrete momenten werken beter dan open vragen. Zo staat het in beide agenda's en kunnen jullie morgen samen gaan. Tik de knop hieronder.",
      },
      ...afsluitStappenV9(8),
    ],
    waarInEleva: [
    ...
    vandaagDoen: [
      {
        ...
        verplicht: true,
        uitleg:
          "Kies één warme prospect voor deze 3-weg, iemand bij wie je gevoel zegt: hier voelt het goed. Uit je top-5, uit reageerders op je laatste posts, of uit je freebie-leads. Niet de meest 'gemakkelijke' kiezen, wel iemand die warm voelt, want bij koude prospects wordt een 3-weg vaak een verkooppoging. Schrijf voor jezelf even op waarom je deze persoon kiest, dan zit ze ook in je hoofd klaar voor het gesprek.",
      },
      {
        ...
        actieRoute: "/scripts?cat=uitnodiging",
        uitleg:
          "Stuur de stap-1-introductie naar je sponsor en je prospect volgens het script dat je gisteren hebt klaargezet. Eén bericht naar je sponsor met 'ik ga X uitnodigen voor woensdag, ben je erbij?', en één naar je prospect met de uitnodiging in jouw stem. Houd het natuurlijk in toon, geen formeel verhaal. Een paar uur tevoren stuur je nog een korte herinnering 'tot zo, leuk dat we elkaar straks spreken'. Zo is iedereen voorbereid en weet wat 'r te wachten staat.",
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Zet 'm in de agenda met je sponsor en prospect, en doorloop samen de vijf stappen. Jij doet stap 1 (de edification), daarna neemt je sponsor het over voor stap 2 en 3, je prospect stelt vragen, en jij sluit af met de vervolgafspraak in stap 5. Tijdens stap 3 (de inhoud) doe jij niets behalve actief luisteren, je sponsor leidt en jij leert van het luisteren. Een beetje spanning hoort erbij, gewoon doen. Jij kan dit, en je sponsor staat naast je.",
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Tien minuten na afloop reflecteer je met de Mentor: wat ging goed, wat voelde onhandig, wat heeft je prospect gezegd dat je niet had voorzien? Hij noteert dit allemaal, en je hebt het straks bij de edification-verdieping in stap 17 hard nodig. Niet alleen wat misging benoemen, ook waar je verraste van jezelf, dat is belangrijker dan je denkt. Vijf tot tien minuten is genoeg, je hoeft 'r geen huiswerk van te maken.",
      },
      ...afsluitStappenV9(9),
    ],
    waarInEleva: [
    ...
    vandaagDoen: [
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Family, Occupation, Recreation, Money. Vier onderwerpen die in een gewoon gesprek vanzelf langskomen, en die je bewust kunt gebruiken om iemand te leren kennen voordat je iets voorstelt. Geen interview-checklist, geen vragenlijst die je afwerkt. Wel een set onderwerpen waarvan je weet dat ze in een ontspannen gesprek vanzelf opduiken. Je let er bewust op, je onthoudt wat er gezegd wordt, en je gebruikt het later. De Mentor licht ze in twee minuten met je door.",
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Loop met de Mentor de vier FORM-vragen door voor je top-5: wat weet je al per onderwerp, wat ontbreekt nog? Hij noteert per prospect in je Mentor-profiel, zodat 'ie bij elke volgende 3-weg-voorbereiding al weet wat jij over deze persoon hebt onthouden. Reken op een halfuur als je serieus door je top-5 wil, het is best wat werk maar je hebt 'r maandenlang plezier van. Investeren waar het echt iets oplevert.",
      },
      {
        ...
        verplicht: false,
        uitleg:
          "Spreek je deze week iemand uit je top-5 toch al? Pak die ontmoeting dan en let bewust op de vier FORM-onderwerpen. Niet als interview, gewoon in het gewone gesprek. Update na afloop je notitie in ELEVA met wat je hebt opgevangen. Spontane FORM in een natuurlijke ontmoeting is goud waard, want je leert iemand kennen zonder dat het ergens 'naar' voelt. Dit is hoe je 't straks structureel doet, vandaag oefen je 'm.",
      },
      ...afsluitStappenV9(10),
    ],
    waarInEleva: [
...
Lekker bezig, ga zo door 💪🏽`,
    vandaagDoen: [
      ...
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Spreek vandaag met jezelf af: minimaal vijf nieuwe namen per week toevoegen aan je lijst. Geen 'ik zal proberen', wel concreet vijf per week. Eén via een gesprek met iemand uit je netwerk, eentje via een Story-reactie, eentje via een freebie-lead, en zo door, op de manier die voor jou werkt. De Mentor onthoudt deze afspraak en herinnert je er wekelijks aan. Zonder die instroom droogt je lijst op, want je laat ook type-5-mensen los, dus er moet net zoveel bijkomen als er uitgaat.",
      },
      {
        ...
        uitleg:
          "Open je freebie-opt-in-lijst en bekijk welke nieuwe leads je sinds vorige week hebt gekregen. Markeer elk van hen met het juiste type uit de vorige stap, zodat je weet wie warm is en wie je rustig laat. Niet allemaal meteen benaderen, wel allemaal op de kaart. De warmste paar (type 1) plan je deze week in voor contact, de rest zet je op de juiste plek in je opvolgritme. Eén keer per week even doorlopen is een mooi ritme.",
      },
      ...afsluitStappenV9(11),
    ],
    waarInEleva: [
    ...
    vandaagDoen: [
      {
        ...
        verplicht: true,
        uitleg:
          "Plaats vandaag minimaal één Story en kies een van de drie richtingen. Lifestyle: een glimp van je dag, een glimp van wat jij doet, je werkplek, of een moment uit je gezin met permissie. Waarde: één tip of inzicht op een mooie achtergrond. Eigen verhaal: iets wat je deze week leert of merkt aan jezelf, eerlijk en zonder schmink. Mag onaf, mag rommelig, want stories zijn vluchtig en menselijk. Het gaat erom dat je begint, niet dat 'ie perfect is.",
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Plaats deze week minimaal één Story die je freebie aankondigt, met de link erbij (swipe-up of link-in-bio, afhankelijk van wat je platform toelaat). Mensen die je Stories volgen kijken vaak veel meer dan mensen die je posts zien, en een Story-link werkt heel direct. Combineer 'm met een vraag of een herkenbare situatie, dan klikken mensen makkelijker door. Eén keer per week is een prima ritme om mee te beginnen.",
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Plan vandaag een vast dagelijks Story-moment in: ochtend, lunchpauze, of avond, wat past in jouw leven. Niet onderhandelen met jezelf, gewoon vastleggen. Mensen die een vast moment hebben blijven posten, mensen die 't 'wel zien wanneer' doen, posten meestal niet. Eén moment per dag is genoeg, je hoeft geen Story-influencer te worden. Consistentie boven perfectie.",
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Maak je eerste Reel met hulp van de Mentor. Hij levert het script en de structuur: hook in de eerste twee seconden (wat trekt mensen aan), inhoud in 15 tot 45 seconden (één punt of één verhaal), en een call-to-action of zachte uitnodiging in de laatste vijf seconden. Jij filmt 'm met je telefoon, monteert 'm, en plaatst 'm. Een Reel hoeft niet perfect, 'ie hoeft eerlijk te zijn. Een perfecte Reel die er nooit komt helpt niemand, een eerlijke rommelige die er wel staat kan precies dat ene contact opleveren.",
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Reageer binnen een uur op DM's en op reacties op je stickers. Hier zit het echte contact, en op tijd zijn houdt het warm. De Mentor staat klaar voor opener-zinnen bij DM's waar het standaard-script niet helemaal past, vraag 'm gewoon mee te denken in het moment. Eén woordje persoonlijk maken doet wonderen, gebruik haar naam of een verwijzing naar iets uit haar Story of profiel. Zo voelen mensen dat je echt naar ze kijkt en niet copy-paste werkt.",
      },
      {
        ...
        uitleg:
          "Verdieping over Stories die werken, in je eigen tempo. De Academy-module 'Stories die werken' gaat dieper in op patronen, voorbeelden, en concrete formats die in praktijk blijken te werken. Handig als je er dieper in wil duiken, niet verplicht. Eén keer doorlopen als 't even rustig is, en je hebt 'r maandenlang plezier van.",
      },
      ...afsluitStappenV9(12),
    ],
    waarInEleva: [
    ...
    vandaagDoen: [
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Vraag de Mentor 'waar denk je dat mijn natuurlijke niche ligt?'. Hij heeft inmiddels veel van je gehoord uit de eerste twaalf stappen, en haalt daar een conclusie uit. Bijvoorbeeld 'ik hoor in je verhalen vaak iets over slaap en hoe je dat zelf hebt zien veranderen, je top-5 zit ook veel in die hoek, dat zou kunnen wijzen op een natuurlijke niche rond slaap en herstel'. Het is een aanbieding, geen verdict, dus je mag tegenspreken en bijsturen. Op basis van het gesprek bouw je samen een richting die klopt met wat in jouw vingers zit.",
      },
      {
        ...
        uitleg:
          "Leg je niche-richting vast in één zin: waar wil je herkenbaar in zijn? Bijvoorbeeld 'slaap en herstel voor drukke ondernemers' of 'hormonen rondom 40+'. Nog niet voor altijd, wel een vertrekpunt voor de komende stappen, zodat je content scherper kan worden. Je mag later schuiven, een niche is geen tatoeage. Bewaar 'm bij je eigen zinnen, de Mentor gebruikt 'm voortaan als kompas voor jouw content en aanbevelingen.",
        inlineActie: {
          type: "tekst",
          slug: "niche-richting",
      ...
      },
      {
        ...
        verplicht: true,
        uitleg:
          "Plan voor deze week twee of drie posts of Stories die expliciet binnen je nieuwe niche-richting vallen. Test in praktijk of het klopt of dat het wringt, en wat de reacties daarop zijn. De Mentor helpt 'm concretiseren naar onderwerpen en hoeken die binnen jouw niche passen. Reflecteer in een volgende sessie met de Mentor op wat werkte en wat niet, dan ga je 'm verfijnen op basis van echte data uit jouw publiek. Niet meteen oordelen, geef het een paar dagen.",
      },
      ...afsluitStappenV9(13),
    ],
    waarInEleva: [
    ...
    vandaagDoen: [
      {
        ...
        actieRoute: "/namenlijst",
        uitleg:
          "Markeer in je namenlijst twee tot drie klanten met netwerker-energie. Dat herken je aan vier signalen: ondernemend (vragen over hoe je het doet, niet alleen wat je verkoopt), mensen-mens (houdt van contact, heeft veel mensen om zich heen), doorzettingsvermogen (blijft aan iets bouwen ook als het traag gaat), en leerbaar (accepteert dat 'r iets nieuws te leren is en zoekt zelf naar info). Niet alle vier hoeven gelijk in beeld te zijn, twee is genoeg om iemand op je radar te zetten. Vandaag alleen markeren, morgen gaan we ze gericht benaderen.",
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Praat vijf minuten met de Mentor over je ideale klant. Hij stelt vragen om het profielblok 'ideale klant' op te bouwen in jouw Mentor-profiel: leeftijdsrange, levensfase (jong gezin, kinderen het huis uit, eigen leven na carrière), werksituatie, wat ze zoeken (energie, slaap, hormonen, lifestyle, ondernemen), en wat hen tegenhoudt om in beweging te komen. Op basis van jouw eerste klanten heb je inmiddels gevoel voor wie goed loopt en wie moeite heeft, dat gebruikt 'ie daarbij. Niet om mensen buiten te sluiten, wel om je communicatie scherper te krijgen.",
      },
      {
        ...
        actieRoute: "/coach",
        uitleg:
          "Bereid voor één klant met netwerker-energie alvast een webshop-versie van de uitnodiging voor. Niet versturen vandaag, wel klaarzetten. Gebruik wat je over die persoon weet (uit FORM, uit eerdere gesprekken) zodat 'ie persoonlijk voelt. De Mentor helpt 'm in jouw stem schrijven, met de juiste haak voor deze ene persoon. In stap 15 of 16 stuur je 'm pas, zodra het voelt als het juiste moment. Vandaag is voorbereiding, dat is bewust.",
      },
      ...afsluitStappenV9(14),
    ],
    waarInEleva: [
