...
export const t: Vertalingen = {
  ...
  "login.wachtwoord_vergeten": {
    nl: "Wachtwoord vergeten?", en: "Forgot password?",
    fr: "Mot de passe oubli\u00e9 ?", es: "\u00bfOlvidaste tu contrase\u00f1a?",
    de: "Passwort vergessen?", pt: "Esqueceu a senha?",
  },
  "herstel.vraag_titel": {
    nl: "Wachtwoord vergeten", en: "Forgot password",
    fr: "Mot de passe oubli\u00e9", es: "Olvidaste tu contrase\u00f1a",
  ...
  "herstel.vraag_intro": {
    nl: "Vul je e-mailadres in. Je krijgt een mail met een link om een nieuw wachtwoord in te stellen.",
    en: "Enter your email address. You'll receive an email with a link to set a new password.",
    fr: "Saisissez votre adresse e-mail. Vous recevrez un e-mail avec un lien pour d\u00e9finir un nouveau mot de passe.",
    es: "Introduce tu correo electr\u00f3nico. Recibir\u00e1s un correo con un enlace para establecer una nueva contrase\u00f1a.",
    de: "Gib deine E-Mail-Adresse ein. Du erh\u00e4ltst eine E-Mail mit einem Link, um ein neues Passwort festzulegen.",
    pt: "Digite seu endere\u00e7o de e-mail. Voc\u00ea receber\u00e1 um e-mail com um link para definir uma nova senha.",
  },
  "herstel.vraag_knop": {
    nl: "Stuur herstel-link", en: "Send reset link",
    fr: "Envoyer le lien", es: "Enviar enlace",
    de: "Link senden", pt: "Enviar link",
  },
  "herstel.vraag_knop_laden": {
    nl: "Versturen...", en: "Sending...",
    fr: "Envoi...", es: "Enviando...",
    de: "Senden...", pt: "Enviando...",
  },
  "herstel.vraag_gelukt": {
    nl: "Gelukt. Check je mail (ook je spam) voor de link om je wachtwoord opnieuw in te stellen.",
    en: "Done. Check your email (including spam) for the link to reset your password.",
    fr: "C'est fait. V\u00e9rifiez votre e-mail (et les spams) pour le lien de r\u00e9initialisation.",
    es: "Listo. Revisa tu correo (y el spam) para encontrar el enlace de restablecimiento.",
    de: "Erledigt. Sieh in deinem E-Mail-Postfach (auch im Spam) nach dem Link zum Zur\u00fccksetzen.",
    pt: "Pronto. Verifique seu e-mail (e o spam) para o link de redefini\u00e7\u00e3o.",
  },
  "herstel.terug_naar_login": {
    nl: "Terug naar inloggen", en: "Back to login",
    fr: "Retour \u00e0 la connexion", es: "Volver a iniciar sesi\u00f3n",
    de: "Zur\u00fcck zur Anmeldung", pt: "Voltar para o login",
  },
  "herstel.vraag_fout": {
  ...
  "herstel.controleren": {
    nl: "Even controleren...", en: "Checking...",
    fr: "V\u00e9rification...", es: "Comprobando...",
    de: "Wird gepr\u00fcft...", pt: "Verificando...",
  },
  "herstel.nieuw_titel": {
    nl: "Nieuw wachtwoord instellen", en: "Set a new password",
    fr: "D\u00e9finir un nouveau mot de passe", es: "Establecer una nueva contrase\u00f1a",
    de: "Neues Passwort festlegen", pt: "Definir uma nova senha",
  },
  "herstel.nieuw_label": {
    nl: "Nieuw wachtwoord", en: "New password",
    fr: "Nouveau mot de passe", es: "Nueva contrase\u00f1a",
    de: "Neues Passwort", pt: "Nova senha",
  },
  "herstel.nieuw_bevestig": {
    nl: "Herhaal wachtwoord", en: "Repeat password",
    fr: "R\u00e9p\u00e9tez le mot de passe", es: "Repite la contrase\u00f1a",
    de: "Passwort wiederholen", pt: "Repita a senha",
  },
  "herstel.nieuw_knop": {
    nl: "Wachtwoord opslaan", en: "Save password",
    fr: "Enregistrer", es: "Guardar contrase\u00f1a",
    de: "Passwort speichern", pt: "Salvar senha",
  },
  "herstel.nieuw_knop_laden": {
    nl: "Opslaan...", en: "Saving...",
    fr: "Enregistrement...", es: "Guardando...",
    de: "Speichern...", pt: "Salvando...",
  },
  "herstel.nieuw_gelukt": {
    nl: "Je wachtwoord is opgeslagen.", en: "Your password has been saved.",
    fr: "Votre mot de passe a \u00e9t\u00e9 enregistr\u00e9.", es: "Tu contrase\u00f1a se ha guardado.",
    de: "Dein Passwort wurde gespeichert.", pt: "Sua senha foi salva.",
  },
  "herstel.fout_kort": {
    nl: "Kies een wachtwoord van minstens 8 tekens.",
    en: "Choose a password of at least 8 characters.",
    fr: "Choisissez un mot de passe d'au moins 8 caract\u00e8res.",
    es: "Elige una contrase\u00f1a de al menos 8 caracteres.",
    de: "W\u00e4hle ein Passwort mit mindestens 8 Zeichen.",
    pt: "Escolha uma senha com pelo menos 8 caracteres.",
  },
  "herstel.fout_ongelijk": {
    nl: "De twee wachtwoorden zijn niet gelijk.",
  ...
  "herstel.link_ongeldig": {
    nl: "Deze herstel-link is ongeldig of verlopen. Vraag een nieuwe aan.",
    en: "This reset link is invalid or expired. Request a new one.",
    fr: "Ce lien est invalide ou expir\u00e9. Demandez-en un nouveau.",
    es: "Este enlace no es v\u00e1lido o ha expirado. Solicita uno nuevo.",
    de: "Dieser Link ist ung\u00fcltig oder abgelaufen. Fordere einen neuen an.",
    pt: "Este link \u00e9 inv\u00e1lido ou expirou. Solicite um novo.",
  },
  "herstel.fout_opslaan": {
    nl: "Opslaan mislukt. Probeer het opnieuw of vraag een nieuwe link aan.",
    en: "Could not save. Try again or request a new link.",
    fr: "\u00c9chec de l'enregistrement. R\u00e9essayez ou demandez un nouveau lien.",
    es: "No se pudo guardar. Int\u00e9ntalo de nuevo o solicita un enlace nuevo.",
    de: "Speichern fehlgeschlagen. Versuche es erneut oder fordere einen neuen Link an.",
