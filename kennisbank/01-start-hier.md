...
**Status:** ~90% compleet. Einde van de kaart (Boards-app download-instructies + daarna) is afgekapt. Zie § *Gaten* onderaan.

---

## Folder-structuur

De folder `1️⃣ START HIER` bevat één kaart:

- **WELKOM START HIER**

(Andere subkaarten of sub-folders: niet waargenomen in opgehaalde content.)
...
### Het systeem dat je helpt bouwen 🔑
...
> We hebben het simpel voor je gemaakt.

- Je ontvangt je **eigen webshop** om je bestellingen te doen en je link te delen.
- **Vraag naar de WhatsApp-community** voor het team & ontvang je support.

**Download de gratis Boards-app** (Android / iOS) voor je stap-voor-stap complete opleiding. Bij installatie:

- *What industry are you part of?* → druk op **OTHER**
- *Type your company* → **Lifeplus**
- Kies: **I'm part of the team**

---

## Inzichten voor ELEVA (human-first filter toegepast)
...
- [ ] Of er attachments/video's aan deze kaart hangen

Volgende stap volgens STATE-OF-BUILD: folder **2. JOUW EERSTE 10 DAGEN** → `kennisbank/02-eerste-10-dagen.md`.
