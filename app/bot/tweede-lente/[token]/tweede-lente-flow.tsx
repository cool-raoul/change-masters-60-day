...
//
// Client-flow voor de Tweede Lente bot. Zes stappen:
//   intro       Warme uitnodiging in team-stem
//   intekenen   E-mail + naam VOORAF (filter)
//   vragen      7 multi-choice vragen
//   spiegel     AI-spiegel + ankers + nutriënten + basis-tips
//   opt-in      Product-pakketten + contact-aanbod + submit
//   klaar       Bevestiging
//
// Toont BotHeader op elke stap met voortgangs-indicatie.
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-6 sm:py-10 space-y-6">
      ...
      <div className="rounded-3xl bg-white/85 backdrop-blur-md border border-white shadow-lg p-6 sm:p-8">
        ...
        {blok === "klaar" && (
          <BlokKlaar memberVoornaam={memberVoornaam} />
        )}
      </div>
    </div>
  );
      ...
      <div className="mt-6 rounded-2xl bg-rose-50 border border-rose-100 px-5 py-4 text-left max-w-md mx-auto">
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm text-gray-700 leading-relaxed">
            ...
            vraag? Stuur {memberVoornaam} gerust een berichtje, ze heeft
            je hier persoonlijk uitgenodigd.
          </div>
        </div>
      </div>
