...
export function detecteerVraagType(berichten: { role: string; content: string }[]): VraagType {
  ...
  if (/\b(productadvies|product advies|welk pakket|welke producten|pakket (voor|bij)|lifeplus advies|daily light|proanthenols|omegold|mena plus|key tonic|enerxan|triple protein|be focused|be recharged|be sustained|golden milk|cacao boost|support tabs|purple flash|green medley|cogelin|biotic blast|aloe vera|parabalance|digestive formula|basispakket|supplement|vitamine|mineraal|magnesium|vezel|probiotica|prebiotica|omega|afvallen|intermittent fasting|keto|vasten|burn.?out|stress|slaap|slecht slapen|menopauze|overgang|pms|menstruatie|hormonen|gewrichten|gewricht|stijfheid|artrose|pijn|detox|sappenkuur|darmprogramma|holistic reset|darm|darmen|spijsvertering|stoelgang|obstipatie|constipatie|diarree|opgeblazen|winderigheid|naar (het|de) toilet|moeilijk poepen|niet kunnen poepen|buikpijn|maagpijn|brandend maagzuur|reflux|energie|moe|vermoeid|brain fog|concentratie|focus|hoofdpijn|migraine|huid|acne|eczeem|psoriasis|haaruitval|nagels|immuun|verkoudheid|griep|allergie|hooikoorts|gezondheid|klacht|vitaliteit|holistisch|vitaliteitsprogramma|cholesterol|bloeddruk|bloedsuiker|suiker|diabetes|sport|training|performance|herstel|spieren|workout|fitness|cardio|eiwit|eiwitten|proteine|proteïne|ouder worden|veroudering|anti.?aging|libido|seks|vruchtbaarheid)\b/.test(recenteUserBerichten)) return "productadvies";
