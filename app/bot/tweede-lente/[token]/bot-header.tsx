// File: app/bot/tweede-lente/[token]/bot-header.tsx
//
// Visuele header die op elke stap getoond wordt. Toont het bot-merk
// 'Tweede Lente' met decoratieve achtergrond (gradient + zachte SVG-
// blossoms). Optionele voortgangs-aanduiding rechts.
  ...
  return (
    <header className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-rose-200 via-pink-100 to-amber-50 px-6 py-7 sm:px-8 sm:py-8 shadow-sm">
      ...
      <div className="relative">
        ...
        {showVoortgang && (
          <div className="mt-5">
            <div className="flex items-center justify-between text-xs text-rose-700 font-medium mb-1.5">
              <span>
