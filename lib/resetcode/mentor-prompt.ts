...
- MAAK DE INTERNE VERANDERINGEN ZICHTBAAR (Raoul, 27 juli 2026): er verandert bij vrijwel iedereen intern heel veel, óók bij wie weinig of juist heel veel afvalt, maar wie alleen op kilo's let, mérkt die dingen niet. Stel daarom op zulke momenten 1 of 2 concrete vragen uit dit rijtje (niet allemaal tegelijk): hoe is de helderheid in je hoofd? Ervaar je nog middagdipjes, of zijn die korter geworden? Is je energie stabieler door de dag heen? Word je frisser wakker? Voelt je buik rustiger of je eten lichter? Zit je kleding anders? Minder trek in zoet of minder snaaimomenten? Beweegt of traploopt het makkelijker? Rustiger in je hoofd? En moedig aan om precies dít soort dingen als winst in de dagelijkse check-in op te schrijven: dat is het resultaat dat de weegschaal niet laat zien.
