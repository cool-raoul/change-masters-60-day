...
In ons team zien we het patroon.. de mensen die in week één al een beetje overweldigd voelen.. zijn vaak degenen die het halen. Iets nieuws leert iedereen rommelig.. dan vloeiend.
...
Eerst dit, want het is belangrijk om vooraf te zeggen.. je top-20 is geen lijst van mensen die jij een webshop wil verkopen. Het is een lijst van mensen die jij op enige manier zou kunnen verrijken met wat jij nu zelf doet.
...
Schrijf eerst tot je op twintig namen zit. Filteren komt later, en doe je nooit voor iemand anders. Wij hebben in ons team echt regelmatig de mensen die de top-20 het meest "gefilterd" hadden, terug horen komen met.. "Die ene die ik nooit zou benaderen, is mijn eerste klant geworden."
...
Vandaag stuur je er drie. Mét je sponsor erbij 💪🏽
...
Twee: je persoonlijke gebruik in het Mentor-profiel.
...
Drie verhalen. Eén voor elk moment dat een prospect het van je wil horen.
...
Daarnaast: edification-basics.

Edification, dat is een woord uit het vak.. en wat het betekent is.. je sponsor introduceren op een manier die hem of haar laat schitteren. Zodat een prospect bij jullie eerste gesprek samen al respect heeft voor je sponsor, vóórdat ie iets heeft gezegd.
...
Bouwen mag leuk zijn 💪🏽`,
  ...
  {
    nummer: 5,
    titel: "🛡️ Bezwaren, 3-weg, Mini-ELEVA — basis-gereedschap",
    fase: 1,
    faseDoel:
...
Bouwen mag leuk zijn 💪🏽`,
  ...
  {
    nummer: 6,
    titel: "📱 Social media — basis, Brookes, eerste freebie",
    fase: 2,
    faseDoel:
...
Twee dingen om mee te dragen vanaf vandaag.
...
**Waarom Builder en niet meteen een hogere rang?**
...
Vandaag maak je je eerste Reel. Reels vergen iets meer voorbereiding dan Stories, maar zijn nog steeds doable.
...
Je freebie zichtbaar via Stories. Plaats deze week minimaal één Story die je freebie aankondigt. Met de link erbij — swipe-up of link-in-bio. Mensen die je Stories volgen kijken vaak meer dan je posts, en een Story-link werkt heel direct.
...
Belangrijk: jij beslist. Niet de Mentor.
...
En dan de webshop-uitnodiging uit gisteren.
...
Vóór je begint met schrijven, even reflecteren op de vorige post.
...
Eén ding wat er ook in zit vandaag.. Tijdlijn-moment 3.
...
Waar sta je nu, kijk op je dashboard. De Builder-tegel laat twee dingen zien:
...
Wat kun je deze week doen om dichterbij te komen?
...
Een ander deel van vandaag.. duplicatie.
