...
// ============================================================
// Tekst voor de "ðŸ¤ Check je partners"-stap die verschijnt zodra
// een member directe downline heeft. De component PartnerCheckEmbed
// rendert zichzelf onzichtbaar als geen partners gevonden â€” dus de
...
Hieronder zie je je directe partners (en optioneel de 2e laag via uitklap-knop). Per partner: hun dag, hun laatste login, en hoeveel % van hun verplichte taken ze deze week hebben afgevinkt. Een âš ï¸-icoon verschijnt bij urgentie (>72u stil OF <30% taken).
...
export function partnerCheckStap(dagNummer: number): ControllableTaak {
  return {
    ...
    label: "ðŸ¤ Check je nieuwe partner(s) vandaag",
...
export function momentumRadarStap(dagNummer: number): ControllableTaak {
  return {
    ...
    label: "ðŸŽ¯ Open momentum-acties van vandaag",
...
export const AANPAK_KIEZEN_UITLEG = `Dagelijkse check: heeft iemand sinds gisteren gekeken of laat weten "ja, ik wil meer weten"?\n\nLege pijplijn vandaag? Sla dit over. Deze taak wacht op je tot er een prospect klaarstaat. Geen reactie binnen, geen actie hier. Check 'm gewoon morgen weer.\n\nWel iemand die heeft gekeken of meer wil weten? Open z'n kaart en kies Ã©Ã©n van twee paden via het keuzeblok bovenaan. App je sponsor erbij: "HÃ© [sponsornaam], [prospect] heeft gekeken. Zullen we even kort: 3-weg of Mini-ELEVA?"\n\nðŸ¤ 3-WEG-GESPREK voor warme prospects die snel willen schakelen, kort traject, persoonlijk contact passend. Sponsor doet het zwaardere praatwerk, jij brengt vertrouwen. Stappenplan staat klaar achter de '3-weg'-knop op de kaart, dag 9 verdiep je dit.\n\nâœ¨ MINI-ELEVA voor prospects met een druk leven, mensen die eerst zelf willen kijken, of wanneer een 3-weg-gesprek qua planning niet snel lukt en je momentum wilt houden. 14 dagen eigen toegang, welkomstvideo's, AI-mentor, chat met jou en je sponsor. Klik 'Mini-ELEVA-uitnodiging maken' op de kaart.\n\nBeide paden zijn volwaardig, je kiest wat past bij die prospect Ã©n jouw situatie. Niet zeker? Druk 'Overleg met sponsor' in het keuzeblok.`;
...
export function aanpakKiezenStap(dagNummer: number): ControllableTaak {
  return {
    ...
    label: "ðŸ§­ Heeft iemand gekeken of meer willen weten? Kies de aanpak",
...
// dag 3 of 4 â€” dat zou overweldigend zijn voor een member die net
...
function bouwDag3VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    // --- Stap A: nieuwe namen toevoegen ---
    {
      ...
      label: `ðŸ“² Voeg ${dd.contacten} nieuwe namen toe aan je lijst`,
    ...
    // --- Stap C: openstaande follow-ups ---
    {
      ...
      label: "ðŸ”„ Doe je openstaande follow-ups vandaag",
    ...
    {
      id: "dag3-stories",
      label: "ðŸ“± 1 tot 3 stories + reageren op andermans stories",
    ...
    {
      id: "dag3-teams-admin",
      label: "ðŸ“‹ Teams-administratiesysteem aanmaken",
      uitleg:
    ...
    // --- LAATSTE STAP: sponsor-checkin (afsluiting van de dag) ---
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
...
function bouwDag4VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    // --- Stap A: nieuwe namen toevoegen (dagritme) ---
    {
      ...
      label: `ðŸ“² Voeg ${dd.contacten} nieuwe namen toe aan je lijst`,
      uitleg: `Dagritme blijft: ${dd.contacten} nieuwe mensen toevoegen aan je netwerk-overzicht. Mensen uit je telefoon die je nog niet hebt benaderd, social-media-vrienden waar je al een tijd niet mee hebt gesproken, mensen die je dagelijks tegenkomt, of nieuwe verbindingen via socials. EÃ©n woord context per persoon is genoeg.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur een persoonlijk eerste bericht.\n\nðŸ“± DIRECT IN WHATSAPP/IG/FB BELANDEN: in je namenlijst staan naast elke prospect kleine icoontjes (WhatsApp, Instagram, Facebook). EÃ©n klik en de juiste app opent met die persoon. Vereiste: telefoonnummer of social-handle staat op de kaart. Niet ingevuld? Open de prospect, vul aan, en de icoontjes verschijnen vanzelf.\n\nLINK MET DE LES VAN VANDAAG: dit is je OPENER. Je 4-stappen-uitnodiging hierboven leer je vandaag niet om in losse berichten over weken uit te smeren, maar om in dezelfde chat-flow door te zetten zodra het natuurlijk past. Topcoaches zijn het er over eens: openen â†’ korte verbinding â†’ uitnodigen, het liefst in dezelfde gespreksbeurt, hooguit binnen een paar berichten. Wachten met de uitnodiging tot 'over een week' voelt voor de prospect als een verborgen agenda.\n\nPRAKTISCH:\n\n1. Open met een menselijke, specifieke vraag (geen pitch). "HÃ© [naam], moest aan je denken omdat..." of "HÃ© [naam], hoe gaat het nu met...?"\n2. Laat ze reageren. Lees wat ze NOEMEN (energie, druk, doelen, zorgen).\n3. Brug naar de uitnodiging: gebruik de 4-stappen-formule van vandaag. Compliment â†’ uitnodiging â†’ twee tijdsblokken. Heb je hulp nodig? Drie knoppen onder de hoofd-stap brengen je naar voorbeelden, je sponsor of de Mentor.\n\nVia de spraakfunctie meld je: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'. Zodra je hen ook uitnodigt: "Ik heb [naam] uitgenodigd" â†’ fase 'uitgenodigd'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    {
      id: "dag4-bestellinks",
      label: "ðŸ”— Bestellinks koppelen, begin vandaag met zoveel mogelijk",
      uitleg:
    ...
    // --- LAATSTE STAP: sponsor-checkin (afsluiting van de dag) ---
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "Je hebt dag 4 erop zitten. Stuur je sponsor in 30 seconden hoe het ging: hoe voelde de 4-stappen-uitnodiging? Natuurlijk of nog stroef? EÃ©n zin is genoeg.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(4),
...
function bouwDag5VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur ze 1-op-1 een persoonlijk bericht.\n\nðŸ“± HOE JE DIRECT IN WHATSAPP, INSTAGRAM OF FACEBOOK BELANDT\n\nIn je namenlijst staan naast elke prospect kleine icoontjes (WhatsApp, Instagram, Facebook). EÃ©n klik en de juiste app opent met die persoon. Vereiste: telefoonnummer of social-handle staat op de kaart. Niet ingevuld? Open de prospect, vul aan, en de icoontjes verschijnen vanzelf.\n\nDIT IS EEN OPENER, GEEN CASUAL CATCH-UP\n\nEen eerste bericht is bedoeld om een gesprek te openen dat BINNEN 1 TOT 3 BERICHTEN leidt tot een uitnodiging voor een kijkmoment. Niet om eerst weken te koffieklokken.\n\nWAT SCHRIJF JE\n\nGeen pitch. WÃ©l een menselijke, specifieke vraag waar je oprecht nieuwsgierig naar bent.\n\nVoorbeelden:\n- "HÃ© Linda, ik moest aan je denken na onze koffie laatst. Hoe is het nu met die nieuwe rol?"\n- "HÃ© Pieter, ik zag je verhaal over je wandeling in Limburg. Welke route was dat?"\n\nZodra je het bericht hebt verstuurd, vertel het aan de spraakfunctie: "Ik heb een gesprek gestart met [naam]". De prospect gaat dan automatisch van 'prospect' naar 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap C: uitnodigingen (vanaf dag 5 vast onderdeel van het ritme) ---
    {
      ...
      label: `ðŸ“¨ Verstuur ${dd.uitnodigingen} uitnodigingen (4-stappen-formule)`,
    ...
    // basis-uitleg zonder drie-stappen-frame â€” FFF is nog niet
    ...
    // --- Stap F: Feel-Felt-Found-roleplay (dag-specifiek) ---
    {
      ...
      label: "ðŸ›¡ï¸ Korte Feel-Felt-Found-roleplay (FFF) met sponsor of Mentor",
      uitleg:
...
function bouwDag6VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur ze een persoonlijk eerste bericht.\n\nðŸ“± DIRECT IN WHATSAPP/IG/FB BELANDEN: in je namenlijst staan naast elke prospect kleine icoontjes (WhatsApp, Instagram, Facebook). EÃ©n klik en de juiste app opent met die persoon. Vereiste: telefoonnummer of social-handle staat op de kaart.\n\nDit is een OPENER, geen casual catch-up. Doel: binnen 1-3 berichten leiden naar een uitnodiging. Vandaag verstuur je later ook uitnodigingen, voor mensen die warm reageren kun je vandaag al doorzetten.\n\nVia de spraakfunctie meld je: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap D: openstaande follow-ups (UITGEBREIDE uitleg op dag 6) ---
    {
      ...
      label: "ðŸ”„ Follow-ups vandaag (24-48u-regel + 5-fasen-flow)",
    ...
    {
      id: "dag6-sponsor-tip",
      label: "ðŸ’¡ Vraag sponsor of Mentor: 1 tip op je lastigste follow-up",
      uitleg:
...
function bouwDag7VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    {
      id: "dag7-review",
      label: "ðŸ“‹ Vul de wekelijkse review in (5 min reflectie)",
      uitleg:
    ...
    // --- Stap 1B: Funnel-analyse door ELEVA Mentor ---
    {
      ...
      label: "ðŸ” Laat ELEVA je funnel analyseren (eerste keer)",
      uitleg:
    ...
    // --- Stap 2: namen toevoegen (MINIMAAL) ---
    {
      ...
      label: `ðŸ“² Voeg minimaal ${min.contacten} namen toe aan je lijst`,
    ...
    // --- Stap 4: uitnodigingen (MINIMAAL) ---
    {
      ...
      label: `ðŸ“¨ Verstuur minimaal ${min.uitnodigingen} uitnodigingen`,
      uitleg: `Minimaal ${min.uitnodigingen} uitnodigingen vandaag, meer mag. Pas de 4-stappen-formule toe. Compliment â†’ uitnodigen â†’ plan met twee opties â†’ eventueel haast (alleen business).\n\nHulp nodig? De drie knoppen onder dit vak: voorbeelden, sponsor of Mentor.`,
      verplicht: true,
      actieRoute: "/namenlijst",
      uitnodigHelpKnoppen: true,
    },
    ...
    // --- LAATSTE STAP: sponsor-call (15 min, langer dan checkin) ---
    {
      ...
      label: "ðŸ“ž 15 min sponsor-call over week 2",
      uitleg:
        "Wat werkte? Wat gaan we anders doen? Wat is het thema van week 2? Deze call is langer dan een dagelijkse checkin, neem 15 minuten samen om week 1 door te lopen en week 2 vorm te geven. Tip: deel je review-formulier vÃ³Ã³r de call zodat je sponsor zich kan voorbereiden.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(7),
 ...
 * de C-stap (uitnodigingen) doet â€” dus de F-stap staat ZONDER eigen
...
function bouwDag8VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur ze een persoonlijk eerste bericht.\n\nðŸ“± DIRECT IN WHATSAPP/IG/FB: in je namenlijst staan naast elke prospect kleine icoontjes (WhatsApp, Instagram, Facebook). EÃ©n klik en de juiste app opent. Geen kopiÃ«ren-en-plakken, geen zoeken.\n\nDit is een opener, geen casual catch-up. Doel: binnen 1-3 berichten leiden naar een uitnodiging. Via de spraakfunctie meld je: "Ik heb een gesprek gestart met [naam]".`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
 ...
 *
 * Dag 9-thema: 3-weg-gesprek meesterclass â€” 5 stappen + edification.
...
function bouwDag9VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    // --- Stap A: nieuwe namen toevoegen ---
    {
      ...
      label: `ðŸ“² Voeg ${dd.contacten} nieuwe namen toe aan je lijst`,
      uitleg: `Dagritme: ${dd.contacten} nieuwe mensen toevoegen aan je netwerk-overzicht. EÃ©n woord context per persoon.\n\nGebruik de vier bronnen (Eleva-geheugen, Facebook, Instagram, LinkedIn) in de strip hieronder als ingang.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur ze een persoonlijk eerste bericht.\n\nðŸ“± DIRECT IN WHATSAPP/IG/FB: in je namenlijst staan naast elke prospect kleine icoontjes. EÃ©n klik en de juiste app opent met die persoon.\n\nDit is een opener, geen casual catch-up. Via de spraakfunctie: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
...
function bouwDag10VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    // --- Stap A: nieuwe namen toevoegen ---
    {
      ...
      label: `ðŸ“² Voeg ${dd.contacten} nieuwe namen toe aan je lijst`,
      uitleg: `Dagritme: ${dd.contacten} nieuwe mensen toevoegen. EÃ©n woord context per persoon. Gebruik de vier bronnen in de strip hieronder.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen en stuur een persoonlijk eerste bericht.\n\nðŸ“± Gebruik de kleine icoontjes in je namenlijst om direct in WhatsApp/Instagram/Facebook te belanden, geen kopiÃ«ren-en-plakken.\n\nVia de spraakfunctie: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
...
function bouwDag11VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    ...
    // --- Stap B: eerste berichten ---
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen en stuur een persoonlijk eerste bericht.\n\nðŸ“± Gebruik de kleine icoontjes in je namenlijst om direct in WhatsApp/Instagram/Facebook te belanden.\n\nVia de spraakfunctie: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    ...
    // --- Stap F: pipeline-check + leerstof (dag-specifiek) ---
    {
      ...
      label: "ðŸŽ¯ Pipeline-check: weet voor elke prospect wat de volgende stap is",
      uitleg:
        "Bovenaan deze pagina onder 'Wat je leert' staat de uitleg over one-pager versus presentatie. Lees die door, daarna doe je deze check.\n\nDE KERN IN Ã‰Ã‰N ZIN: niemand slaat een stap over. Iedereen doorloopt: prospect â†’ uitnodiging â†’ one-pager of 3-weg â†’ presentatie â†’ beslissing. Geen sprongen, geen omleidingen.\n\nDE CHECK (5 minuten)\n\nOpen je namenlijst, schakel naar pijplijn-weergave. Kijk per fase wat je ziet:\n\nâ€¢ PROSPECT: nog niet benaderd. Doel: vandaag of morgen een opener sturen.\nâ€¢ IN GESPREK: eerste bericht is uit, gesprek loopt. Doel: zodra het natuurlijk past, een uitnodiging sturen volgens de 4-stappen-formule.\nâ€¢ UITGENODIGD: uitnodiging is verstuurd, wachtend op JA. Doel: 24-48u check-in als ze stil zijn.\nâ€¢ ONE-PAGER: info-pagina is gestuurd, wachtend op reactie. Doel: de tussenstap-zin sturen (staat letterlijk uitgeschreven in 'Wat je leert' bovenaan).\nâ€¢ PRESENTATIE: diepgaand gesprek of 3-weg gehad. Doel: de 5-fasen-follow-up volgen (zie dag 6).\nâ€¢ FOLLOW-UP: denkt na, twijfelt. Doel: de openings-zin 'wat spreekt je het meeste in aan?' of FFF bij bezwaren (zie dag 5).\n\nWAAR IS JE VERSTOPPING?\n\nDe fase waar de MEESTE mensen op staan is je verstopping, daar zit je vandaag werk. Per fase een concrete vervolgactie:\n\nâ€¢ Veel mensen op IN GESPREK? Je hebt veel gesprekken lopen maar nog geen uitnodigingen verstuurd. Vandaag: schrijf voor 2 tot 3 van hen een uitnodiging volgens de 4-stappen-formule.\nâ€¢ Veel mensen op UITGENODIGD? Ze hebben ja gezegd op een kijkmoment maar nog geen info gekregen. Vandaag: stuur ze de one-pager of plan een 3-weg in.\nâ€¢ Veel mensen op ONE-PAGER? Ze hebben gekeken maar je hebt nog geen vervolg gestuurd. Vandaag: stuur de tussenstap-zin (zie 'Wat je leert' bovenaan voor de letterlijke tekst).\nâ€¢ Veel mensen op PRESENTATIE? Goed werk, hier zit veel van de echte beweging. Volg de 5-fasen-follow-up van dag 6.\nâ€¢ Veel mensen op FOLLOW-UP? Ze denken na. Stuur een natuurlijke heropener of, als ze een bezwaar hebben geuit, pas Feel-Felt-Found (FFF) toe van dag 5.\n\nDe truc is niet om alle fases tegelijk te bedienen, wel om VANDAAG je grootste verstopping te ontstoppen.",
      verplicht: true,
      actieRoute: "/namenlijst",
    },
  ...
  return [
    {
      ...
      label: `ðŸ“² Voeg ${dd.contacten} nieuwe namen toe aan je lijst`,
      uitleg: `Dagritme: ${dd.contacten} nieuwe mensen toevoegen aan je netwerk-overzicht. EÃ©n woord context per persoon ('fitness', 'oud-collega', 'koffietent').\n\nGebruik de vier bronnen (Eleva-geheugen, Facebook, Instagram, LinkedIn) in de strip hieronder als ingang. Warm voor koud.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    {
      ...
      label: `ðŸ’¬ Stuur ${dd.contacten} mensen een eerste bericht`,
      uitleg: `Pak ${dd.contacten} mensen uit je lijst en stuur een persoonlijk eerste bericht.\n\nðŸ“± In je namenlijst staan naast elke prospect kleine icoontjes (WhatsApp, Instagram, Facebook). EÃ©n klik en de juiste app opent met die persoon, geen kopiÃ«ren-en-plakken.\n\nDit is een opener, geen casual catch-up. Doel: binnen 1-3 berichten leiden naar een uitnodiging. Via de spraakfunctie: "Ik heb een gesprek gestart met [naam]" â†’ fase 'in gesprek'.`,
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    {
...
function bouwDag12VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...
    },
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "30 seconden. Heb je vandaag een pivot gedaan? Of een nee-die-warm-blijft? Stuur je sponsor in Ã©Ã©n zin hoe het ging.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(12),
 ...
 * Thema: FORM (Family, Occupation, Recreation, Money) â€” rapport bouwen.
 */
function bouwDag13VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...
    },
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "30 seconden. Bij welke prospect heb je FORM toegepast? Welke 'haak' heb je opgevangen? Stuur je sponsor Ã©Ã©n zin.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(13),
...
function bouwDag14VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    {
      id: "dag14-review",
      label: "ðŸ“‹ Vul de week 2-review in (5 min reflectie)",
      uitleg:
    ...
    },
    {
      ...
      label: "ðŸ” Laat ELEVA je funnel analyseren",
      uitleg:
    ...
    ...standaardABCDEstappen(14, uren),
    {
      ...
      label: "ðŸ” Bekijk je hele pijplijn: wie zit waar?",
      uitleg:
        "Open je namenlijst in pijplijn-weergave. Tel per fase. Waar stokt het? Dat is het thema voor week 3.\n\nDE KORTE BOTTLENECK-ANALYSE\n\nâ€¢ Veel op UITGENODIGD zonder antwoord? Uitnodigingen herzien (dag 4).\nâ€¢ Veel op ONE-PAGER zonder reactie? Follow-up te direct of mist focus op WAT raakte (dag 6).\nâ€¢ Veel op PRESENTATIE zonder beslissing? Closing-werk komt op dag 17 (Doel-Tijd-Termijn).\n\nDe volledige bottleneck-uitleg met 40-dagen-fix per type staat bovenaan onder 'Wat je leert'.",
      verplicht: true,
      actieRoute: "/namenlijst",
    },
    {
      id: "dag14-sponsor-call",
      label: "ðŸ“ž 15 min sponsor-call: week 3 voorbereiden",
      uitleg:
        "Wat werkte deze week? Wat liep niet soepel? Wat is het thema van week 3? Neem 15 minuten samen om week 2 door te lopen en week 3 vorm te geven. Tip: deel je review-formulier vÃ³Ã³r de call zodat je sponsor zich kan voorbereiden.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(14),
 ...
 * Thema: 5 types prospects â€” energie waar het telt.
 */
function bouwDag16VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...
    },
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "30 seconden. Hoeveel type 1+2 prospects heb je geÃ¯dentificeerd? Dat is je echte werk-voorraad. Stuur je sponsor het aantal.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(16),
...
function bouwDag17VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...standaardABCDEstappen(17, uren),
    {
      ...
      label: "âœï¸ Schrijf jouw eigen openings-closing-zin (5 min)",
      uitleg:
        "EÃ©n vaste zin waarmee jij Doel-Tijd-Termijn introduceert in een gesprek. Bewaard onder /mijn-zinnen zodat je 'm altijd snel kunt oppakken. De 5 vragen + voorbeelden staan bovenaan onder 'Wat je leert'.",
      verplicht: true,
      inlineActie: {
        type: "tekst",
    ...
    },
    {
      ...
      label: "ðŸŽ¯ Pas Doel-Tijd-Termijn toe bij minstens 1 warme prospect",
      uitleg:
    ...
    },
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "30 seconden. Heb je vandaag Doel-Tijd-Termijn toegepast? Bij wie, hoe verliep het? Stuur je sponsor Ã©Ã©n zin.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(17),
 ...
 * Thema: Edification â€” de zin die je sponsor laat schitteren.
...
function bouwDag18VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...standaardABCDEstappen(18, uren),
    {
      ...
      label: "âœ¨ Schrijf jouw eigen edification-zin (5 min)",
      uitleg:
        "EÃ©n vaste zin van max 25 woorden waarmee je je sponsor introduceert in elk 3-weg of bij elke presentatie. Bewaard onder /mijn-zinnen, altijd snel terug te vinden.\n\nDE FORMULE (volledig uitleg bovenaan onder 'Wat je leert'):\n1. Wie introduceer je?\n2. Wat is hun track-record of autoriteit?\n3. Waarom heb JIJ ze gekozen?\n\nGeen overdrijving, gewoon de waarheid, sterk gebracht.",
      verplicht: true,
      inlineActie: {
        type: "tekst",
    ...
    },
    {
      ...
      label: "ðŸŽ¯ Pas je edification-zin minstens 1Ã— toe deze week",
      uitleg:
        "Bij je eerstvolgende 3-weg of presentatie: gebruik de zin letterlijk vÃ³Ã³r je sponsor introduceert. Niet improviseren, gewoon zeggen. Goede edification verandert een gesprek waar drie mensen praten in een setting waar de prospect denkt: 'wow, deze persoon weet Ã©cht waar het over gaat'.",
      verplicht: false,
      actieRoute: "/namenlijst",
    },
    {
 ...
 * Thema: Pipeline-check â€” waar lekt je trechter? Handmatige pijplijn-
 ...
 * Thema: Vraag de beslissing â€” de moedigste vraag van het vak.
 */
function bouwDag20VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  return [
    ...
    },
    {
      ...
      label: "ðŸ’¬ Sluit af met een korte sponsor-checkin",
      uitleg:
        "30 seconden. Bij wie heb je vandaag of morgen voor de beslissing gevraagd? Wat was de reactie? Stuur je sponsor Ã©Ã©n zin, ongeacht de richting is dit een winst.",
      verplicht: false,
      inlineEmbed: "sponsor-melding",
    },
    aanpakKiezenStap(20),
...
function bouwDag21VandaagDoen(uren: CommitmentUren): ControllableTaak[] {
  ...
  return [
    {
      id: "dag21-review-3",
      label: "ðŸ“‹ Vul de week 3-review in (5 min)",
      uitleg:
    ...
    },
    {
      ...
      label: "ðŸªž Reflectie: hoe voelt de eerste 21 dagen?",
      uitleg:
        "Wat leerde je over jezelf? Waar groeide je? Wat was moeilijker dan gedacht? Wat bleek makkelijker? Deze reflectie gaat naar je sponsor en helpt bij jullie 40-min call straks.\n\nWAT JE IN 21 DAGEN HEBT GEDAAN (erkÃ©n het)\n\nâ€¢ Een namenlijst van 100+ mensen aangelegd (was 0)\nâ€¢ Tussen de 100 en 200 uitnodigingen verstuurd\nâ€¢ Bezwaren leren behandelen met Feel-Felt-Found (FFF)\nâ€¢ 3-weg-gesprekken gestart en gevoerd\nâ€¢ Edification, FORM, Doel-Tijd-Termijn als technieken in je gereedschapskist\nâ€¢ 1-3 beslissingen binnen (member, shopper of not-yet)\n\nDit is een fundament. Het echte gebouw zet je in de komende 40 dagen.",
      verplicht: true,
      actieRoute: "/statistieken",
    },
    {
      id: "dag21-funnel-analyse",
      label: "ðŸ” 21-dagen-oogst: laat ELEVA je complete funnel analyseren",
      uitleg:
    ...
    {
      id: "dag21-doel-40",
      label: "ðŸŽ¯ Stel 1 concreet doel voor de volgende 40 dagen",
      uitleg:
    ...
    },
    {
      ...
      label: "ðŸ“ž 40 min sponsor-call: week 3 afsluiten + blok 2 voorbereiden",
      uitleg:
