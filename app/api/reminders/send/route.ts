...
export async function GET(request: Request) {
  ...
  // Deze route wordt elk uur aangeroepen door GitHub Actions (gratis hourly
  // cron, Vercel Hobby laat dat niet toe). Per run sturen we dus alleen naar
  // users wiens voorkeurstijd op dit moment in hun tijdzone valt.
