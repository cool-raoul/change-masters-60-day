        ...
        {ACADEMY_TRAININGEN.map((t) => {
          ...
          return (
            <Link
              key={t.slug}
              href={`/academy/${t.slug}`}
              className="block card hover:border-cm-gold/60 transition-colors group"
            >
              <div className="flex gap-4 items-start">
                ...
                <span className="text-cm-gold text-2xl flex-shrink-0 self-center">
                  →
                </span>
              </div>
            </Link>
