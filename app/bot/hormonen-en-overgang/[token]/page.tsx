// File: app/bot/hormonen-en-overgang/[token]/page.tsx

import { notFound } from "next/navigation";
import type { Metadata } from "next";
import { createAdminClient } from "@/lib/supabase/admin";
import { HormonenEnOvergangFlow } from "./flow";
...
export async function generateMetadata({
  ...
  const titel = "Hormonen & Overgang, persoonlijke score + uitgebreid advies";
...
export default async function HormonenEnOvergangTokenPagina({
  params,
}: {
  params: Promise<{ token: string }>;
}) {
  ...
  if (!row || row.bot_slug !== "hormonen-en-overgang") {
    notFound();
  }
  ...
  // Bestellinks voor hormoonbalans-pakketten
