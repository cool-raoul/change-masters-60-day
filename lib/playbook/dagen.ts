...

  {
    ...
    vandaagDoen: [
      ...
      },
      {
        ...
        uitleg:
          "Kies 3 warmere mensen uit je lijst. Stel het bericht samen met je sponsor op tijdens jullie call, of vraag de Mentor: 'Schrijf een uitnodiging voor [naam] die [context]'. Drempel laag houden, gewoon doen, niet perfect. Eerste uitnodigingen voelen altijd onhandig, dat hoort.\n\nHOE KLINKT EEN EERLIJK BERICHT?\n\nEen sterk uitnodigingsbericht is kort, eerlijk en persoonlijk, en draait om het webshop-frame: jij hebt een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis webshop met holistische wellness-producten. Hieronder vijf voorbeelden voor verschillende contexten. Niet letterlijk overnemen, sponsor of Mentor maakt er straks een versie van die past bij wie jij gaat appen.\n\n💛 Voorbeeld 1 (warm + eigen WHY):\n\n'Hé [naam], ik ben [beroep] en ik wil graag [doel uit eigen WHY, bv. een dagje in de week minder werken]. Ik heb een manier gevonden om dat te doen via een gratis online webshop met hoogwaardige holistische wellness-producten. Het enige wat ik hoef te doen is producten voor mezelf bestellen die ik dagelijks toch al gebruik. Alle logistiek wordt geregeld, er is gratis hulp en training, en een AI-systeem voor support om aan klanten te komen. Mag ik je kort laten zien hoe het werkt?'\n\n💬 Voorbeeld 2 (kort + duplicatie-focus):\n\n'Hé [naam], ik heb een manier gevonden om online extra inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis webshop met holistische wellness-producten. Ik help anderen ook hoe ze zo'n gratis webshop kunnen krijgen voor een extra inkomstenstroom naast hun werk. Mag ik je daar kort iets over sturen?'\n\n✨ Voorbeeld 3 (vanuit eigen ervaring):\n\n'Hé [naam], [eigen ervaring in 1-2 zinnen, bv. \"ik kan 's middags weer doorpakken in plaats van die 3-uur-dip\"]. Allemaal door producten uit mijn eigen webshop. Het mooie: zo'n webshop kost je niets, je bestelt er zelf in en daarmee staat-ie. Iedereen kan dat hebben. Sta je open om te zien hoe?'\n\n🎯 Voorbeeld 4 (met prospect-WHY-haakje, alleen als je hun WHY kent):\n\n'Hé [naam], ik heb een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis holistische webshop. Jij gaf vorige keer aan dat je [hun WHY, bv. \"graag een dag minder zou willen werken\"]. Ik denk dat dit echt bij jou zou kunnen passen. Sta je open om te kijken wat dit voor jou zou kunnen betekenen?'\n\n🌱 Voorbeeld 5 (koud / oud contact heractiveren):\n\n'Hé [naam], we hebben elkaar al een tijdje niet gesproken, maar ik moest aan je denken. Ik heb een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis webshop met holistische wellness-producten. Niet wetende of het bij je past, dacht ik gewoon: vraag het even. Sta je open om te kijken wat het is? Helemaal vrijblijvend, als het niets voor je is is dat ook prima.'\n\n💡 MEER VOORBEELDEN voor specifieke contexten (lead-magnet, social, familie, business-builder, etc.): open /scripts → Uitnodigingen-tabblad → filter op tag 'webshop'. Daar staan 14 varianten klaar, allemaal in dezelfde stem.\n\nWAT MAAKT DEZE BERICHTEN STERK?\n\n• Eerlijk vooraf wat het is, geen mysterie.\n• Webshop als anker: gratis, zelf bestellen, alles geregeld.\n• Keuze nadrukkelijk bij de ander, geen druk.\n• Duidelijke vervolgvraag (permissie-vraag, niet agenda-vraag).\n\nVOORDAT JE STUURT, CHECK:\n\n• Heb je [naam] en alle placeholders vervangen?\n• Past de toon bij hoe jij normaal met deze persoon praat?\n• Heb je het hardop voorgelezen, voelt het natuurlijk?\n• Klaar om rustig op reactie te wachten? Aandringen werkt averechts.\n\nZeggen ze ja? Plan het gesprekje liefst samen met je sponsor in. Zo leer je het sneller dan in je eentje.",
        verplicht: true,
...
1. Warm + eigen WHY (voor wie je je WHY wilt delen):
"Hé Mark, ik ben [beroep] en ik wil graag [doel uit eigen WHY, bv. een dagje in de week minder werken]. Ik heb een manier gevonden om dat te doen via een gratis online webshop met hoogwaardige holistische wellness-producten. Het enige wat ik hoef te doen is producten voor mezelf bestellen die ik dagelijks toch al gebruik. Alle logistiek wordt geregeld, er is gratis hulp en training, en een AI-systeem voor support om aan klanten te komen. Mag ik je kort laten zien hoe het werkt?"

2. Eigen ervaring + webshop (na een resultaat-moment):
"Hé Linda, ik kan 's middags weer doorpakken in plaats van die 3-uur-dip. Allemaal door producten uit mijn eigen webshop. Het mooie: zo'n webshop kost je niets, je bestelt er zelf in en daarmee staat-ie. Iedereen kan dat hebben. Sta je open om te zien hoe?"

3. Prospect-WHY-haakje (alleen als je hun WHY al kent):
"Hé Sarah, ik heb een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis holistische webshop met wellness-producten. Jij gaf vorige keer aan dat je graag een dag minder zou willen werken. Ik denk dat dit echt bij jou zou kunnen passen. Sta je open om te kijken wat dit voor jou zou kunnen betekenen?"

4. Koud / oud contact heractiveren:
"Hé Tom, we hebben elkaar al een tijdje niet gesproken, maar ik moest aan je denken. Ik heb een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis webshop met holistische wellness-producten. Niet wetende of het bij je past, dacht ik gewoon: vraag het even. Sta je open om te kijken wat het is? Helemaal vrijblijvend, als het niets voor je is is dat ook prima."

5. Serious Business Builder (compliment + samen bouwen):
"Hé Daan, ik moest aan je denken. Wat jij hebt opgebouwd met je bedrijf vind ik echt sterk. Er zijn niet zo veel mensen waar ik denk 'die heeft het echt geleerd om dingen rond te krijgen', bij jou denk ik dat wel. Daarom wil ik je iets laten zien dat ik recent ben gestart. Ik heb een manier gevonden om online inkomsten op te bouwen zonder investeringen en zonder risico, via een gratis webshop met holistische wellness-producten. Wat me erin trok als ondernemer: geen voorraad, geen logistiek, geen klantenservice, alles is geregeld. Loopt parallel aan wat je nu doet, schaalt zonder dat je elke euro met je eigen tijd hoeft te ruilen, en er is gratis training plus AI-systeem voor support. Sta je open om er kort naar te kijken? Helemaal vrijblijvend, als het niets voor je is is dat ook prima."
